...
- **Timestamp:** `2025-12-09T00:09:45.9630433Z`
- **Event:** The user "employee" executed the file `tor-browser-windows-x86_64-portable-15.0.2(1).exe` in silent mode, initiating a background installation of the TOR Browser.
- **Action:** Process creation detected.
- **Command:** `tor-browser-windows-x86_64-portable-15.0.2(1).exe /S`
- **File Path:** `C:\Users\bcook\Downloads\tor-browser-windows-x86_64-portable-15.0.2.exe`

### 3. Process Execution - TOR Browser Launch

- **Timestamp:** `2025-12-09T00:11:34.7517557Z`
- **Event:** User "employee" opened the TOR browser. Subsequent processes associated with TOR browser, such as `firefox.exe` and `tor.exe`, were also created, indicating that the browser launched successfully.
- **Action:** Process creation of TOR browser-related executables detected.
- **File Path:** `C:\Users\bcook\Desktop\Tor Browser\Browser\firefox.exe`

### 4. Network Connection - TOR Network

- **Timestamp:** `2025-12-09T00:13:18.3137482Z`
- **Event:** A network connection to IP `93.95.231.88` on port `9001` by user "bcook" was established using `tor.exe`, confirming TOR browser network activity.
- **Action:** Connection success.
- **Process:** `tor.exe`
- **File Path:** `c:\users\bcook\desktop\tor browser\browser\torbrowser\tor\tor.exe`
...
- **Timestamp:** `2025-12-09T22:11:57.6706384Z`
- **Event:** The user "bcook" created a file named `tor-shopping-list.txt` on the desktop, potentially indicating a list or notes related to their TOR browser activities.
- **Action:** File creation detected.
- **File Path:** `C:\Users\bcook\Desktop\tor-shopping-list.txt`
